  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a undergradueate student <strong className="text-stone-100">in Computer Engineering </strong> 
        at <strong className="text-stone-100">Sharif University of technology</strong>.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm interested in <strong className="text-stone-100"> in memory processing </strong>,
        <strong className="text-stone-100"> AI accelerators </strong> and other{' '}
        <strong className="text-stone-100">Computer Architecture </strong> related topics.
      </p>
    </>
  ),
  actions: [
